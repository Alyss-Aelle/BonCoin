...
<div class="mt-6 bg-gray-50">
    <div class=" px-10 py-6 mx-auto">
       ...
       <div class="max-w-6xl px-10 py-6 mx-auto bg-gray-50">
          ...
          <a href="#_" class="block transition duration-200 ease-out transform hover:scale-110">
              <img class="object-cover w-300 shadow-sm h-400" src="{{Storage::url($annonce->image)}}">
          </a>

          <!--post categories-->
          <div class="flex items-center justify-start mt-4 mb-4">
              <a href="#"class="px-2 py-1 font-bold bg-red-400 text-white rounded-lg hover:bg-gray-500 mr-4">{{$annonce->category->name}}</a>
           </div>
          <div class="mt-2">
              <!--post heading-->
              <a href="#"
                  class="sm:text-3xl md:text-3xl lg:text-3xl xl:text-4xl font-bold text-purple-500  hover:underline">{{$annonce->name}}</a>

                  <!--post lieux-->
                  <div class="flex justify-start items-center mt-2">
                      <p class="text-sm text-green-500 font-bold bg-gray-100 rounded-full py-2 px-2 hover:text-red-500">{{$annonce->prix}}€</p>
                      <p class="text-sm text-gray-400 font-bold ml-5">{{$annonce->lieux}}</p>
                 ...
                 <div class="font-light text-gray-600">
                      ...
                      <a href="#" class="flex items-center mt-6 mb-6"><img
                          ...
                          <h1 class="font-bold text-gray-700 hover:underline">{{$annonce->user->name}}</h1>
                      </a>
                </div>
         </div>
   ...
   <div class="max-w-4xl px-10  mx-auto text-2xl text-gray-700 mt-4 rounded bg-gray-100">
       ...
       <!--content body-->
       <div>
              <p class="mt-2 p-8">{{$annonce->description}}</p>
       </div>
